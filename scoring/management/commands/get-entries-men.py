...
from ...models import Skater, Competitor, Category, Event, Entry
from .utils import handle_name, get_world_standings
import requests


class Command(BaseCommand):
    help = 'Get newest entries - Men'
    ...
    def handle(self, *args, **kwargs):
        ...
        world_standings = get_world_standings('http://www.isuresults.com/ws/ws/wsmen.htm')
        if url.__contains__("jpn"):
            category = 'data0100.htm'
            url += category
